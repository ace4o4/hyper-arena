...
const teamData = {
  ...
  players: [
    { name: "RushKing", uid: "5234567890", email: "player2@example.com", role: "Fragger" },
    { name: "ScopeGod", uid: "5345678901", email: "player3@example.com", role: "Sniper" },
    { name: "MedKit", uid: "5456789012", email: "player4@example.com", role: "Support" },
    { name: "ClutchMaster", uid: "5567890123", email: "player5@example.com", role: "IGL" },
  ],
  substitute: { name: "BackupPro", uid: "5678901234", email: "sub@example.com" },
};
