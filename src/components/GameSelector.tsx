              ...
              <div className="relative z-10">
                <div className="mb-6 flex justify-center">
                  <motion.img
                    src={game.logo}
                    alt={game.name}
                    className="w-32 h-32 object-cover rounded-xl border-2 border-white/10 group-hover:border-white/30 transition-all duration-300"
                    whileHover={{ rotate: 360 }}
                    transition={{ duration: 0.6 }}
                  />
                </div>
                
                <h3 className="text-4xl font-black text-center mb-2">{game.name}</h3>
                <p className="text-muted-foreground text-center mb-6">{game.tagline}</p>
                
                <div className="flex items-center justify-between glass rounded-lg p-4 mb-4">
                ...
                <motion.button
                  ...
                  whileTap={{ scale: 0.98 }}
                  className={`w-full mt-6 bg-gradient-to-r ${game.color} text-white font-bold py-4 rounded-lg uppercase tracking-wider hover:shadow-2xl transition-shadow duration-300`}
                >
                  View Tournaments
                </motion.button>
              </div>
